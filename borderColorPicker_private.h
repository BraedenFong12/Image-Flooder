...
vector<vector<int>> needToFill; // 2d array representing which pixels are filled with border color and which are not

void FillRegion(); // use bfs and find all regions
